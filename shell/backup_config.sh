...
#
back_home=".tmux.conf .gitconfig .emacs .emacs_custom.el .hgrc .chengl6500.rc .rules_arptables.txt .rules_iptables.txt .vimrc .bashrc .zshrc .irssi .xinitrc .remmina/ .ssh/ .config/xfce4/ .config/Terminal/ .gnupg/"
